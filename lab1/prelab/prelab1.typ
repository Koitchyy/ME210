...
+ #text(fill: red)[red red red]: *222 $Omega$*
+ #text(fill: rgb("#6d1010"))[brown] #text(fill: black)[black] #text(fill: red)[red]: *102 $Omega$*
+ #text(fill: yellow)[yellow] #text(fill: rgb("#8b1fff"))[violet] #text(fill: orange)[orange]: *473 $Omega$*
+ #text(fill: rgb("#6d1010"))[brown] #text(fill: black)[black] #text(fill: green)[green]: *105 $Omega$*
